(function() {
  ...
  RouteNode = (function() {
    function RouteNode(_arg) {
      var name, nodeType, parent, _ref2;

      _ref2 = _arg != null ? _arg : {}, name = _ref2.name, nodeType = _ref2.nodeType, parent = _ref2.parent;
  ...
  RouteSettings = (function() {
    function RouteSettings(_arg) {
      var context, load, setup, teardown, unload, _ref2;

      _ref2 = _arg != null ? _arg : {}, setup = _ref2.setup, teardown = _ref2.teardown, load = _ref2.load, unload = _ref2.unload, context = _ref2.context;
  ...
  RoutePath = (function() {
    function RoutePath(_arg) {
      var boundValues, node, parameterObservables, _ref2;

      _ref2 = _arg != null ? _arg : {}, node = _ref2.node, boundValues = _ref2.boundValues, parameterObservables = _ref2.parameterObservables;
    ...
    RoutePath.prototype.getBindings = function() {
      var binding, bindings, index, _i, _len, _ref2;

      bindings = {};
      _ref2 = this.node.bindings;
    ...
    RoutePath.prototype.getParent = function() {
      var bindingCount, boundValues, parameterObservables, _ref2, _ref3;

      if (this.node == null) {
        return null;
      }
      bindingCount = (_ref2 = (_ref3 = this.node.parent) != null ? _ref3.bindings.length : void 0) != null ? _ref2 : 0;
  ...
  parseQueryString = function(queryString) {
    var key, piece, queryParameters, value, _i, _len, _ref2, _ref3;

    queryString = isString(queryString) ? trim(queryString) : "";
    queryParameters = {};
    if (queryString !== "") {
      _ref2 = queryString.split("&");
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        piece = _ref2[_i];
        _ref3 = piece.split("=", 2), key = _ref3[0], value = _ref3[1];
  ...
  getHash = function() {
    ...
    return "#" + ((_ref2 = window.location.href.split("#", 2)[1]) != null ? _ref2 : "");
  };
  ...
  addRoute = function(rootNode, parsedRouteString, settings) {
    ...
    return (recur = function(currentNode, currentIndex) {
      var component, componentName, componentType, nextNode, _base, _ref2, _ref3;
      ...
      switch (componentType) {
        case NodeType.Literal:
          nextNode = (_ref2 = (_base = currentNode.childLiterals)[componentName]) != null ? _ref2 : _base[componentName] = new RouteNode({
          ...
          break;
        case NodeType.Variable:
          nextNode = (_ref3 = currentNode.childVariable) != null ? _ref3 : currentNode.childVariable = new RouteNode({
            name: "" + currentNode.name + component + "/",
            nodeType: componentType,
            parent: rootNode
          });
  ...
  stepSetup = function() {
    var bindings, context, load, parentContext, recur, setup, _ref2, _ref3, _ref4, _ref5;

    SetupCalled = true;
    parentContext = ((_ref2 = (_ref3 = CurrentPath.node) != null ? _ref3.routeSettings : void 0) != null ? _ref2 : {
      context: null
    }).context;
    CurrentPath = CurrentPath.getChild(CurrentTargetPath);
    _ref5 = (_ref4 = CurrentPath.node.routeSettings) != null ? _ref4 : {}, context = _ref5.context, setup = _ref5.setup, load = _ref5.load;
    if (context == null) {
      context = {};
    }
  ...
  stepLoad = function() {
    var bindings, context, load, recur, setup, _ref2, _ref3;
    ...
    _ref3 = (_ref2 = CurrentPath.node.routeSettings) != null ? _ref2 : {}, context = _ref3.context, setup = _ref3.setup, load = _ref3.load;
    if (context == null) {
      context = {};
    }
    if (setup == null) {
  ...
  stepUnload = function() {
    var bindings, context, recur, unload, _ref2, _ref3;

    LoadCompleted = false;
    recur = function() {
      return step();
    };
    _ref3 = (_ref2 = CurrentPath.node.routeSettings) != null ? _ref2 : {}, context = _ref3.context, unload = _ref3.unload;
    if (context == null) {
      context = {};
    }
    if (unload == null) {
  ...
  stepTeardown = function() {
    var bindings, context, recur, teardown, _ref2, _ref3;

    SetupCalled = false;
    _ref3 = (_ref2 = CurrentPath.node.routeSettings) != null ? _ref2 : {}, context = _ref3.context, teardown = _ref3.teardown;
    if (context == null) {
      context = {};
    }
    if (teardown == null) {
  ...
  runObservables = function() {
    var keys, observable, observableList, _i, _len, _ref2, _results;

    keys = objectKeys(diffObjects(PreviousParameters, CurrentParameters));
    PreviousParameters = CurrentParameters;
    _ref2 = CurrentPath.parameterObservables;
    _results = [];
    for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
      observableList = _ref2[_i];
  ...
  Finch = {
    ...
    call: function(uri) {
      var bindings, newPath, previousTargetPath, queryParameters, queryString, _ref2;
      ...
      _ref2 = uri.split("?", 2), uri = _ref2[0], queryString = _ref2[1];
    ...
    navigate: function(uri, queryParams, doUpdate) {
      var builtUri, currentQueryParams, currentQueryString, currentUri, key, piece, queryString, slashIndex, uriParamString, uriQueryParams, value, _ref2, _ref3;

      _ref2 = getHash().split("?", 2), currentUri = _ref2[0], currentQueryString = _ref2[1];
      if (currentUri == null) {
        currentUri = "";
      }
      ...
      _ref3 = uri.split("?", 2), uri = _ref3[0], uriParamString = _ref3[1];
      if (uri.slice(0, 1) === "#") {
        uri = uri.slice(1);
      }
