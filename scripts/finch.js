...
(function() {
  ...
  Finch = {
    ...
    navigate: function(uri, queryParams) {
      var currentQueryParams, currentQueryString, currentUri, key, queryString, uriParamString, uriQueryParams, value, _ref, _ref2;
      _ref = window.location.hash.split("?", 2), currentUri = _ref[0], currentQueryString = _ref[1];
