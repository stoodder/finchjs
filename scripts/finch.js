...
*/
(function() {
  var CurrentHash, CurrentParameters, CurrentPath, CurrentTargetPath, Finch, HashInterval, HashListening, NodeType, NullPath, ParameterObservable, ParsedRouteString, PreviousParameters, RootNode, RouteNode, RoutePath, RouteSettings, addRoute, arraysEqual, contains, countSubstrings, diffObjects, endsWith, extend, findNearestCommonAncestor, findPath, getComponentName, getComponentType, hashChangeListener, isArray, isFunction, isNumber, isObject, isString, objectKeys, objectValues, objectsEqual, parseQueryString, parseRouteString, peek, resetGlobals, splitUri, startsWith, step, stepLoad, stepObservables, stepSetup, stepTeardown, trim, trimSlashes,
  ...
  stepLoad = function() {
    var bindings, context, load, setup, _ref, _ref2;
    if ((CurrentPath != null ? CurrentPath.node : void 0) == null) return;
    ...
    bindings = CurrentPath.getBindings();
    return load.call(context, bindings);
  };
