...
*/
(function() {
  var CurrentHash, CurrentParameters, CurrentPath, CurrentTargetPath, Finch, HashInterval, HashListening, NodeType, NullPath, ParameterObservable, ParsedRouteString, PreviousParameters, RootNode, RouteNode, RoutePath, RouteSettings, addRoute, arraysEqual, contains, countSubstrings, diffObjects, endsWith, extend, findNearestCommonAncestor, findPath, getComponentName, getComponentType, hashChangeListener, isArray, isFunction, isNumber, isObject, isString, objectKeys, objectValues, objectsEqual, parseQueryString, parseRouteString, peek, resetGlobals, splitUri, startsWith, step, stepSetup, stepTeardown, trim, trimSlashes,
  ...
  step = function() {
    var ancestorPath, keys, observable, observableList, _i, _j, _len, _len2, _ref;
