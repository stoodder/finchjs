...
*/
(function() {
  var CurrentHash, CurrentParameters, CurrentPath, CurrentTargetPath, Finch, HashInterval, HashListening, NodeType, NullPath, ParameterObservable, PreviousParameters, RootNode, RouteNode, RoutePath, RouteSettings, addRoute, arraysEqual, contains, diffObjects, endsWith, extend, findNearestCommonAncestor, findPath, getChildRouteString, getComponentName, getComponentType, getParentRouteString, hashChange, isArray, isFunction, isNumber, isObject, isString, objectKeys, objectValues, objectsEqual, parseQueryString, peek, resetGlobals, splitRouteString, startsWith, step, stepSetup, stepTeardown, trim, trimSlashes,
